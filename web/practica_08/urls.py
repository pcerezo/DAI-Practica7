...
urlpatterns = [
    ...
    path(r'music/borrarAlbum/(?\D<pk>)/', views.borrarAlbum, name='borrarAlbum'),
    path(r'music/borrarMusico/(?\D<pk>)/', views.borrarMusico, name='borrarMusico'),
    
    path(r'music/reclamaDatos/', views.reclamaDatos, name='reclamaDatos'),
    
    
    path(r'music/cantidades/', views.cantidades, name='cantidades'),
    path(r'music/albumes_grupo/', views.albumes_grupo, name='albumes_grupo'),
